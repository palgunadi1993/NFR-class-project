...
function  [Mob]=CalculateMob_noBC(matrix_frac_center,matrix_frac_nodes,max_intersection,Pij,Trans,num_matrix,matrix_nodes,new_fracture_nodes_pairs,new_fracture_id,Mob,Swij,swir,wexp,krwro,sorw,oexp,krocw,mu_o,mu_w)
